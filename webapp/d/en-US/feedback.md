...
<webui-restrict-to-role role="1">
    <template slot="valid">
        ...
        <template slot="column" name="action">
            <webui-button theme="danger" start-icon="circle|has-shadow:true|ban" title="Delete Feedback" data-value="{TEMPLATE_ROWDATA}" data-trigger="page-feedback-{_ROWID}-delete"></webui-button>
