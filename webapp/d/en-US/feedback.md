...
<webui-restrict-to-role role="1">
    <template slot="valid">
        ...
        <webui-report label="My Feedback" api="/user/feedback" sort-column="name" bordered theme="info" data-subscribe="refresh-feedback:loadData|filter-feedback:loadData" append-columns=":Action:" filters="filter-feedback" sortable="name;created;updated">
