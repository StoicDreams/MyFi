...
<webui-restrict-to-role role="1">
    <template slot="valid">
        ...
        <template slot="column" name="action">
            <webui-button theme="info" start-icon="eye|has-shadow:true" title="View Feedback" data-value="{TEMPLATE_ROWDATA}" data-trigger="page-feedback-{_ROWID}-delete"></webui-button>
